...
{
    public partial class Emp_DisplaySalaryForm : Form
    {
        public Emp_DisplaySalaryForm()
        {
            InitializeComponent();
            ...
            string query = "select employee.Emp_ID, Emp_FName, Emp_LName, Dep_Name, Job_Description, Emp_Salary, KiwiSaver_Percentage, LE_Annual_Leave, " +
                ...
                "employee_department.Emp_ID = employee_department.Dep_ID = department.Dep_ID and human_resources.leave.Emp_ID = employee.Emp_ID and employee.Emp_ID = 5 ORDER BY LE_ID ASC LIMIT 1; ";
